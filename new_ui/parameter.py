...
class udp_messages:
    ...
    message_PXI_Log_coord="MEAS:LOG:LOGCOORD:"
    message_PXI_Log_parameter="MEAS:LOG:LOGPARAMETER:"
    ...
    response_PXI_Log_coord="ACK:MEAS:LOG:LOGCOORD"
    response_PXI_Log_parameter="ACK:MEAS:LOG:LOGPARAMETER"
